 ...
 */
function wanabima_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Wanabima default saturation level.
	 *
	 * @since Wanabima 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'wanabima_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.wanabima-front-page) .entry-title,
...
.colors-custom .wanabima-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.wanabima-front-page .panel-content .recent-posts article,
...
.colors-custom.wanabima-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Wanabima custom colors CSS.
	 *
	 * @since Wanabima 1.0
	 *
	 ...
	 */
	return apply_filters( 'wanabima_custom_colors_css', $css, $hue, $saturation );
}
