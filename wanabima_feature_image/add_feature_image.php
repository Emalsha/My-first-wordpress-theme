...
function wfi_install_data()
{
    ...
    if (!$row_count > 0) {
        ...
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'feature_page' => '4x4_rally', 'image_position' => 1, 'feature_title' => 'Mud Fun Page', 'feature_sub_title' => 'Under Maintains', 'feature_image' => 'NaN','url'=>''));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'feature_page' => '4x4_rally', 'image_position' => 2, 'feature_title' => 'Mud Fun Page', 'feature_sub_title' => 'Under Maintains', 'feature_image' => 'NaN','url'=>''));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'feature_page' => '4x4_rally', 'image_position' => 3, 'feature_title' => 'Mud Fun Page', 'feature_sub_title' => 'Under Maintains', 'feature_image' => 'NaN','url'=>''));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'feature_page' => '4x4_rally', 'image_position' => 4, 'feature_title' => 'Mud Fun Page', 'feature_sub_title' => 'Under Maintains', 'feature_image' => 'NaN','url'=>''));
