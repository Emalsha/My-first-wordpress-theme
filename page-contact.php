                ...
                <form action="" method="post" onsubmit="return check_captcha_is_filled();" id="formcontact">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="cmessage" class="form-control" id="cmessage" rows="8" required></textarea>
                        </div>
                    </div>
                    <div class="g-recaptcha" data-sitekey="6Le9Z04UAAAAADgJHq9tXWSOwIsy8oBtUrILGdnh" data-callback="capcha_filled"
