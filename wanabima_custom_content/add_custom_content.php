...
function wcc_install_data()
{
    ...
    if (!$row_count > 0) {
        ...
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'the_sloth_bear_season', 'text_page_position' => 1, 'text_title' => 'Big Five Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'the_sloth_bear_season', 'text_page_position' => 2, 'text_title' => 'Big Five Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'the_sloth_bear_season', 'text_page_position' => 3, 'text_title' => 'Big Five Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));

        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'the_asian_elephant_season', 'text_page_position' => 1, 'text_title' => 'Big Five Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'the_asian_elephant_season', 'text_page_position' => 2, 'text_title' => 'Big Five Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'the_asian_elephant_season', 'text_page_position' => 3, 'text_title' => 'Big Five Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));

        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'the_leopard_season', 'text_page_position' => 1, 'text_title' => 'Big Five Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'the_leopard_season', 'text_page_position' => 2, 'text_title' => 'Big Five Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'the_leopard_season', 'text_page_position' => 3, 'text_title' => 'Big Five Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));

        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'the_blue_whale_season', 'text_page_position' => 1, 'text_title' => 'Big Five Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'the_blue_whale_season', 'text_page_position' => 2, 'text_title' => 'Big Five Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'the_blue_whale_season', 'text_page_position' => 3, 'text_title' => 'Big Five Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));

        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'the_sperm_whale_season', 'text_page_position' => 1, 'text_title' => 'Big Five Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'the_sperm_whale_season', 'text_page_position' => 2, 'text_title' => 'Big Five Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'the_sperm_whale_season', 'text_page_position' => 3, 'text_title' => 'Big Five Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        ...
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'land_and_offroad', 'text_page_position' => 1, 'text_title' => 'Off Road Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'land_and_offroad', 'text_page_position' => 2, 'text_title' => 'Off Road Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'land_and_offroad', 'text_page_position' => 3, 'text_title' => 'Off Road Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));

        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'water_sports', 'text_page_position' => 1, 'text_title' => 'Mud Fun Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'water_sports', 'text_page_position' => 2, 'text_title' => 'Mud Fun Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => 'water_sports', 'text_page_position' => 3, 'text_title' => 'Mud Fun Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
