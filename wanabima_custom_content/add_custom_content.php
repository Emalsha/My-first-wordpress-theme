...
function wcc_install_data()
{
    ...
    if (!$row_count > 0) {
        ...
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => '4x4_rally', 'text_page_position' => 1, 'text_title' => 'Mud Fun Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => '4x4_rally', 'text_page_position' => 2, 'text_title' => 'Mud Fun Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
        $wpdb->insert($table_name, array('time' => current_time('mysql'), 'text_page' => '4x4_rally', 'text_page_position' => 3, 'text_title' => 'Mud Fun Page', 'text_sub_title' => 'Under Maintains', 'text' => 'This is a sample data. This will update soon.',));
